		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsupplierformsupplierregistrationform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsupplierformsupplierregistrationform-display": {
								"semanticObject": "comsupplierformsupplierregistrationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.supplierform.supplierregistrationform",
									"url": sap.ui.require.toUrl("com/supplierform/supplierregistrationform")
								}
							}
						}
					}
